...
<p style="text-align:justify">
In this project, machine learning model will predict the probability an online transaction being fraudulent, as indicated by the binary target **isFraud**.</p>
